...
/*BOOL is_early_suspended = FALSE;*/ //superdragonpt move along you idiot piece of crap...
...
/* Vanzo:wangfei on: Wed, 21 Jan 2015 09:43:03 +0800
 * added for skip some frames to avoid black logo
 */
#ifdef VANZO_SKIP_KERNEL_LOGO
    static int update_cnt=7;
    if(0!=update_cnt){
      update_cnt--;
      return ret;
    }
	...
	case MTKFB_POWERON:
   	{
		...
		/*is_early_suspended = FALSE;//no care*/ //superdragonpt TODO ...
		return r;
	}
...
// superdragonpt > move along you piece of crap ...
/*#ifdef CONFIG_COMPAT
...
#endif*/ //superdragonpt END ... and fuck off .. why is this here? oh wait -.- 
...
static int mtkfb_pan_display_proxy(struct fb_var_screeninfo *var, struct fb_info *info)
{
	...
	DISP_LOG_PRINT(ANDROID_LOG_INFO, "AppLaunch", "mtkfb_pan_display_proxy.\n");
#endif
...
int mtkfb_ipoh_restore(struct notifier_block *nb,unsigned long val,void *ign)
{
	switch(val){
		...
		case PM_POST_RESTORE:
			...
			pr_warn("[FB Driver] %s pm_event: %lu\n", __func__, val);
			return NOTIFY_DONE;
	}
	return NOTIFY_OK;
}
