...
//	upmu_set_rg_usbdl_rst(1);		//force leave USBDL mode
 ...
 static kal_uint32 charging_set_current(void *data)
 {
	...
	{
        battery_xlog_printk(BAT_LOG_CRTI,"fan5405 charging_set_current\n");
        ...
        battery_xlog_printk(BAT_LOG_CRTI,"fan5405 charging_set_current,register_value = %d \n",register_value);
	}
	return status;
 } 	
 ...
 static kal_uint32 charging_set_input_current(void *data)
 {
    ...
    {
        battery_xlog_printk(BAT_LOG_CRTI,"fan5405 charging_set_input_current\n");
