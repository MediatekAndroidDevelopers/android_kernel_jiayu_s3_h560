...
/*
static unsigned int mux_to_id(struct clkmux *mux)
{
	//clk_info("mux=0x%x\n", mux);
	//clk_info("muxs=0x%x\n", muxs);
	//clk_info("(mux-muxs)=%d, clkmux=0x%x\n", (mux-muxs), sizeof(struct clkmux));
	return ((mux-muxs));
}
*/
...
static void mt_clks_init(void)
{
    ...
    //clks[MT_CG_DISP1_DPI_PIXEL].mux = &muxs[MT_MUX_MM];
