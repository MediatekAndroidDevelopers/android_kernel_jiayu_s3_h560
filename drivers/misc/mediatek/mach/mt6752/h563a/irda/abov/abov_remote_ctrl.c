...
#define REMOTE_CHIP_I2C_BUSNUM          1
#define GPIO_IR_EINT_PIN            (GPIO62 | 0x80000000)
#define GPIO_REMOTEIR_RESET_PIN     (GPIO61 | 0x80000000)
#define GPIO_VDDIR_EN               (GPIO60 | 0x80000000)
