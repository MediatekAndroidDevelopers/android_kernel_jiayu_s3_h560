...
{   
	...
	{0xc7,1,{0x02}},  
		...
		{0xFB,1,{0x01}},//CMD page select
		{0xFF,1,{0x24}},//RELOAD CMD1
		{0x00,1,{0x01}},
		{0x01,1,{0x0B}},
		{0x02,1,{0x0C}},
		{0x03,1,{0x89}},
		...
		{0xFF,1,{0x20}},//Enter CMD2,1,{Page0
		{0xFB,1,{0x01}},
...
LCM_DRIVER nt35595_auo52_truly_fhd_lcm_drv =
{
    .name			= "nt35595_auo52_truly_fhd",
