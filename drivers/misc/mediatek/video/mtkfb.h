...
#include <linux/types.h> //superdragonpt: fix for inline N alps
#include "mtkfb_info.h"
#include <linux/compat.h>//superdragonpt: fix for inline N alps
...
struct fb_post_video_buffer {
	...
	|| defined(CONFIG_ARCH_MT6753) || defined(CONFIG_ARCH_MT6752) //modified superdragonpt: for our ARCHs
...
#if defined(CONFIG_ARCH_MT6735) || defined(CONFIG_ARCH_MT6735M)\
	|| defined(CONFIG_ARCH_MT6753) || defined(CONFIG_ARCH_MT6752) //superdragonpt: import our ARCHs ...
...
/*extern unsigned int vramsize;*/ //superdragonpt this is not supported TODO ...
#else
