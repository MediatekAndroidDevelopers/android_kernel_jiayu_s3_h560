...
#include <linux/slab.h> //superdragonpt TODO check 3.18.35 slab upstream

#ifdef CONFIG_ARCH_MT6752
#include "../misc/mediatek/mach/mt6752/include/mach/mt_cpufreq.h" //superdragonpt > LP 3.10.x Kernel
#endif

#ifdef CONFIG_ARCH_MT6753 //superdragonpt > for s3+ mt6753
#include "../misc/mediatek/mach/mt6735/include/mach/mt_cpufreq.h"
#endif

#if (defined CONFIG_ARCH_MT6752) || (defined CONFIG_ARCH_MT6753)
#include <asm/topology.h> //superdragonpt TODO check upstream *asm
...
/*#if (defined CONFIG_ARCH_MT6752) || (defined CONFIG_ARCH_MT6753)
	ppb_idx = mt_cpufreq_get_ppb_state();*/ //superdragonpt not supported on 3.10.x
		...
		unsigned int event)
{
	...
	case CPUFREQ_GOV_POLICY_INIT:
		...
		if (!have_governor_per_policy()) {
			...
			/*WARN_ON(cpufreq_get_global_kobject()); TODO superdragonpt <-- Check this shit*/
		}
		...
		if (rc) {
			...
			if (!have_governor_per_policy()) {
				...
				/*cpufreq_put_global_kobject(); TODO superdragonpt <-- Check this shit*/
			}
			return rc;
		}
