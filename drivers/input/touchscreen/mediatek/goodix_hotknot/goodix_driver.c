...
static s32 tpd_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    {
        GTP_ERROR("I2C communication ERROR!");
/* Vanzo:songlixin on: Wed, 04 Feb 2015 16:11:13 +0800
 * otherwise we can not co-exists with other tp
 */
        return -1;
// End of Vanzo: songlixin
    ...
    /* Vanzo:maxiaojun on: Sat, 12 Jul 2014 15:48:32 +0800
     */
#if GTP_HAVE_TOUCH_KEY
...
#ifdef VANZO_DEVICE_NAME_SUPPORT
    {
        ...
        v_set_dev_name(2, "goodix_hotknot");
    }   
#endif       
    tpd_load_status = 1;
